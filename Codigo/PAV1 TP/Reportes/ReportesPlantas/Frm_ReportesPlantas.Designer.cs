namespace PAV1_TP.Reportes.ReportesPlantas
{
    partial class Frm_ReportesPlantas
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btn_CalcularPlanta.SuspendLayout();
			this.SuspendLayout();
			// 
			// tabPage5
			// 
			...
			// rv_stdTipoPlanta
			// 
			this.rv_stdTipoPlanta.Location = new System.Drawing.Point(0, 85);
			...
			// btn_CalcularPlanta
			// 
			this.btn_CalcularPlanta.Controls.Add(this.tabPage1);
			this.btn_CalcularPlanta.Controls.Add(this.tabPage2);
			this.btn_CalcularPlanta.Controls.Add(this.tabPage3);
			this.btn_CalcularPlanta.Controls.Add(this.tabPage4);
			this.btn_CalcularPlanta.Controls.Add(this.tabPage5);
			this.btn_CalcularPlanta.Location = new System.Drawing.Point(13, 13);
			this.btn_CalcularPlanta.Name = "btn_CalcularPlanta";
			this.btn_CalcularPlanta.SelectedIndex = 0;
			...
			this.Controls.Add(this.btn_CalcularPlanta);
			...
			this.btn_CalcularPlanta.ResumeLayout(false);
        ...
        private System.Windows.Forms.TabControl btn_CalcularPlanta;
